<script>
    ...
    const BASE_URL = "https://en.wikipedia.org/w/api.php?action=query&origin=*&format=json&prop=extracts&explaintext=false&exintro&titles=";
...
<MarqueeTextWidget duration="{30}" repeat="{10}">
    <h1 class="marquee" on:click={handleClick}>{ selected && selected.Name }&nbsp;&nbsp;</h1>
</MarqueeTextWidget>
